                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I'm a Data Scientist | Analyst with 2 years of experience in the semiconductor industry, dedicated to improving efficiency and quality through data-driven insights.</p>
                        </div>
                    </div>
                </div>
                <div className="col-span-1 xl:row-span-3">
